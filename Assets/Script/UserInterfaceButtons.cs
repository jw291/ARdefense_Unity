...
//	public GameObject Model;
	...
	{
			GameObject.FindWithTag("Model").transform.Rotate(0, -rotationSpeed * Time.deltaTime-0.1f, 0);
	...
	{
		Debug.Log("Up");
		GameObject.FindWithTag ("Model").transform.Translate (0, 0, -translationSpeed * Time.deltaTime+0.01f);
	}

	public void PositionDownButton ()
	{
		Debug.Log("Down");
		GameObject.FindWithTag ("Model").transform.Translate (0, 0, translationSpeed * Time.deltaTime+0.1f);
	}
